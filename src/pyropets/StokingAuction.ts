...
export default class StokingAuction {
  ...
  bid(tokenId: bigint, donor: bigint) {}
  ...
  donors(tokenId: bigint) {}
  getAuction(tokenId: bigint) {}
  pendingReturns(addr: bigint) {}
  stokingCost(donorA: bigint, donorB: bigint) {}
  withdraw() {}
}
